...
def create_test_data():
    ...
    patient_user = User.objects.create_user(
        username="test_patient_user_hospital_filtering",
        email="test_patient_hospital_filtering@test.com",
        password="testpass123"
    )
...
def create_test_notifications(test_data):
    """Create test notifications for different hospitals"""
...
def test_hospital_filtering_in_notifications(mock_admin_client):
    ...
    # Mock get_request_user to return our test user and admin_client
    with patch('notifications.views.get_request_user', return_value=test_data['staff_user1']), \
         patch('notifications.views.admin_client', mock_admin_client):
